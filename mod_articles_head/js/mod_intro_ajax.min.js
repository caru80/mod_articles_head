...
this.opt.ajaxConfig.s;this.opt.ajaxConfig.catid&&(this.opt.request.catid=this.opt.ajaxConfig.catid);this.opt.ajaxConfig.tag&&(this.opt.request.tag=this.opt.ajaxConfig.tag);var c;this.opt.ajaxConfig.replace?c=b(this.opt.ajaxConfig.target):a&&(c=a.parent());!this.opt.ajaxConfig.filter&&a&&a.remove();var d=b(this.opt.html.loading);c.html(d);b.ajax({url:this.opt.ajaxConfig.url,type:"POST",data:this.opt.request,success:function(a){d.remove();this.opt.ajaxConfig.animate?this.postEffects(a):(this.opt.ajaxConfig.replace?
